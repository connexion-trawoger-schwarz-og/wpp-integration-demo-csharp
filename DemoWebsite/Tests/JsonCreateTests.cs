...
namespace Tests
{
    public class JsonCreateTests
    {
        ...
        public void CreateJsonTest()
        {
            ...
            payment.Options = new Options { Theeme = "myTestTheme" };

            var x = JsonConvert.SerializeObject(new Payload { Payment = payment }, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
